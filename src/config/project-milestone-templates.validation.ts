...
const resolverFixtures: Array<{
  ...
  { name: 'POC', project: project('POC', 'NONE'), expectedTemplateId: '1' },
  {
  ...
  },
  {
    ...
    opportunity: opportunity({ type: 'DELIVERY', subType: 'UPSELL', changeRequestRequirements: [{ id: 'change', requirementId: 'B1', tenantId: 'ten-1', systemId: 'sys-1', hostingType: 'Cloud', cloudPlatform: 'AWS', productType: 'Tangles', mapCenter: '', licenses: 1, users: 1, concurrentSearches: 1, dailySearches: null, monthlySearches: null, concurrentAnalyses: 1, topicAnalyses: null, dailyAnalyses: null, monthlyAnalyses: null, tangles: null, tanglesGo: null, webloc: null, webeye: null, ingest: null, blockchain: '', crossSystemFeatures: [], apiEnabled: '', apiDailyQty: null, apiMonthlyQty: null, aiFeatures: [], additionalFeatures: [], standardMonitors: null, fullMonitors: null, topicMonitors: null }] }),
    expectedTemplateId: '4',
  },
  { name: 'Renewal standard', project: project('RENEWAL', 'STANDARD'), expectedTemplateId: '5' },
  { name: 'Renewal down sell', project: project('RENEWAL', 'DOWN_SELL'), expectedTemplateId: '6' },
  {
...
function validateProjectMilestoneTemplates() {
  ...
  const templateIds: ProjectMilestoneTemplateId[] = ['1', '2', '3', '4', '5', '6', '7', '8']
