...
export const productionSystemMetadata: SystemInventoryMetadata = {
  ...
  headerFields: [
    ...
    { key: 'currentPid', label: 'Current PID', editable: false, source: '2. Header', line: 4, inputType: 'readonly' },
...
export const reusedInternalSystemMetadata: SystemInventoryMetadata = {
  ...
  headerFields: [
    ...
    { key: 'currentPid', label: 'Current PID', editable: false, source: 'POC/Training/Demo pool', line: 4, inputType: 'readonly' },
