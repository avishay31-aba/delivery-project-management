...
const PROJECT_TABS: ProjectFormTab[] = [
  'tenantRequirements',
  'milestones',
  'tasks',
  'systemsTenants',
...
const NEW_TENANT_SECTION: ProjectRequirementSectionMetadata = {
  kind: 'A',
...
const CHANGE_REQUEST_SECTION: ProjectRequirementSectionMetadata = {
  kind: 'B',
...
const STANDARD_RENEWAL_SECTION: ProjectRequirementSectionMetadata = {
  kind: 'C',
...
const METADATA_BY_PROJECT = new Map<string, ProjectFormMetadata>([
  [
    keyForProject('POC', 'NONE'),
    {
      ...
      requirementSections: [NEW_TENANT_SECTION],
      tabs: PROJECT_TABS,
  ...
  [
    keyForProject('DELIVERY', 'UPSELL'),
    {
      ...
      headerFields: DELIVERY_RENEWAL_HEADER_FIELDS,
      requirementSections: [NEW_TENANT_SECTION, CHANGE_REQUEST_SECTION],
      tabs: PROJECT_TABS,
  ...
  [
    keyForProject('RENEWAL', 'STANDARD'),
    {
      ...
      headerFields: DELIVERY_RENEWAL_HEADER_FIELDS,
      requirementSections: [STANDARD_RENEWAL_SECTION],
      tabs: PROJECT_TABS,
