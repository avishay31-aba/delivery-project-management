...
export const INFRASTRUCTURE_PROPERTY_VALUE_REFERENCE_TYPE: ReferenceDataType = 'INFRASTRUCTURE_PROPERTY_VALUE'
export const INFRASTRUCTURE_MAINTENANCE_TASK_TYPE_REFERENCE_TYPE: ReferenceDataType = 'INFRASTRUCTURE_MAINTENANCE_TASK_TYPE'
export const INFRASTRUCTURE_MAINTENANCE_ASSIGNED_RESOURCE_REFERENCE_TYPE: ReferenceDataType = 'INFRASTRUCTURE_MAINTENANCE_ASSIGNED_RESOURCE'
...
export const REFERENCE_DATA_TYPE_LABELS: Record<ReferenceDataType, string> = {
  ...
  INFRASTRUCTURE_PROPERTY_VALUE: 'Infrastructure Property Value',
  INFRASTRUCTURE_MAINTENANCE_TASK_TYPE: 'Infrastructure Maintenance Task Type',
  INFRASTRUCTURE_MAINTENANCE_ASSIGNED_RESOURCE: 'Infrastructure Maintenance Assigned Resource',
}
