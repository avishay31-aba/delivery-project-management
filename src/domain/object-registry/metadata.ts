...
export const SYSTEM_OBJECT_DEFINITION: ObjectDefinition = {
  ...
  tabs: [
    ...
    { id: 'linkedProjects', label: 'Linked Projects', source: { domain: 'LinkedProjects', exportName: 'linkedProjectRowsForSystem' } },
...
export const TENANT_OBJECT_DEFINITION: ObjectDefinition = {
  ...
  tabs: [
    ...
    { id: 'linkedProjects', label: 'Linked Projects', source: { domain: 'LinkedProjects', exportName: 'linkedProjectRowsForTenant' } },
    { id: 'documents', label: 'Documents', source: { domain: 'DocumentCollection' } },
  ],
  relationships: [
