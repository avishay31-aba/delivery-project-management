...
export function createEmptyDashboardViews(): PersistedDashboardViews {
  return {
    ...
    dashboards: {
      ...
      cancelledInfrastructure: createEmptyScopeViews(),
      infrastructurePlannedMaintenance: createEmptyScopeViews(),
      infrastructureCurrentMaintenance: createEmptyScopeViews(),
    },
  }
}
