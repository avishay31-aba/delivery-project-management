...
export function normalizePersistedDashboardViews(value: unknown): PersistedDashboardViews {
  ...
  return {
    ...
    dashboards: {
      ...
      cancelledSystems: sanitizeDashboardScopeViews(value.dashboards.cancelledSystems),
      tenants: sanitizeDashboardScopeViews(value.dashboards.tenants),
      cancelledTenants: sanitizeDashboardScopeViews(value.dashboards.cancelledTenants),
      ...
      cancelledInfrastructure: sanitizeDashboardScopeViews(value.dashboards.cancelledInfrastructure),
