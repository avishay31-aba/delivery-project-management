...
export const router = createHashRouter([
  {
    ...
    children: [
      ...
      { path: 'systems/new', element: <Navigate to="/systems/production-inventory/new" replace /> },
      { path: 'systems/production-inventory', element: <SystemsWorkspacePage /> },
      { path: 'systems/production-inventory/new', element: <ProductionSystemInventoryFormPage /> },
      ...
      { path: 'systems/reused-internal/new', element: <ReusedInternalSystemFormPage /> },
      { path: 'systems/reused-internal/:mid', element: <ReusedInternalSystemFormPage /> },
      { path: 'systems/cancelled', element: <SystemsWorkspacePage /> },
